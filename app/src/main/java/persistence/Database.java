...
//    // list of all recipes
//    private ArrayList<objects.Recipe> recipeList;
    ...
    //we return arraylist of type objects.Recipe object
    private ArrayList<Recipe> getAllRecipesFromCSV(){

        ArrayList<Recipe> RecipeAll = new ArrayList<>();

        try{
            File f1 = new File("./Database/objects.Recipe.csv");
            ...
            // Read objects.Recipe data line by line
            ...
            while ((RecipeLine = readRecipe.readLine()) != null) {
                ...
                while ((ingredLine = readIngredient.readLine()) != null) {
                    ...
                    // If the name matches, add to the objects.Recipe object
